...
//#include <ogcsys.h> //TODO: Port to WiiU libs
//#include <gccore.h> //TODO: Port to WiiU libs
#include <sys/dir.h>
// #include <sdcard/wiisd_io.h> //TODO: Port to WiiU libs
//#include <fat.h> //TODO: Port to WiiU libs

// Mtx GXmodelView2D; SDL_RENDERER_PRESENTVSYNC
...
void WADPicker()
{
	...
	SDL_Surface *screen;
	screen = SDL_SetVideoMode(640, 480, 16, SDL_RENDERER_PRESENTVSYNC);
  	...
  	// Do alpha fading for start button
		if (STARTALPHA >= 253)
		  ...
		  if (STARTFADEIN)
				...
				STARTALPHA-=5;
		SDL_SetAlpha(startButton, SDL_GetSurfaceAlphaMod, STARTALPHA);
  	if (selectedIWAD != -1)
		{
...
void D_DoomMain(void)
{
  ...
  // Load WAD Picker
	//WADPicker(); //TODO: Port to WiiU libs
